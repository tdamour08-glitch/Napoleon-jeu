...
export const TERRITOIRES = [
  ...
  T('maghreb', 'Régences barbaresques', 3.0, 33.0, 'bar', 'desert', [0, 0, 1, 1, 1], { capitale: true }),
  T('etats_unis', 'États-Unis', -78.0, 39.0, 'usa', 'plaine', [3, 3, 2, 2, 1], { capitale: true, population: 2 }),
  ...
  T('chine', 'Empire Qing', 110.0, 32.0, 'qin', 'plaine', [2, 3, 3, 3, 3], { capitale: true, population: 3 }),
  T('indochine', 'Indochine', 103.0, 15.0, 'qin', 'jungle', [3, 3, 0, 1, 1], { population: 1 }),
  T('inde', 'Confédération marathe', 78.0, 21.0, 'mar', 'plaine', [2, 2, 1, 2, 3], { capitale: true, population: 3 }),
  T('asie_centrale', 'Khanats d\'Asie centrale', 65.0, 42.0, 'kha', 'steppe', [0, 1, 0, 1, 2], { capitale: true }),
